var schema = new Schema({
  ...
  module.exports = mongoose.model('MarketingMerchant', schema);
  
  var exports = _.cloneDeep(require("sails-wohlig-service")(schema, "createdBy lastUpdatedBy merchantCategory", "createdBy lastUpdatedBy merchantCategory"));
  var model = {
      search1: function (data, callback) {
          ...
          var aggregatePipeline = [
            ...
            //           "from": "rules",
            //           "localField": "_id",
            //           "foreignField": "Marketingmerchant",
            //           "as": "rules"
            //       }
            //   }
          ];
      ...
      search: function (data, callback) {
          ...
          MarketingMerchant.find({
              ...
              .page(options,
                  function (err, found) {
                      if (err) {
                          console.log('**** error at Marketingmerchant of Marketingmerchant.js ****', err);
                          callback(err, null);
